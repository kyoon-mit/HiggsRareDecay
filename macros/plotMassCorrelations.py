...
for num in mclist:
   spec['num'] = num
spec['num'] = 10
filename = '{base}/{mvadir}/outname_mc{num}_{cat}_{Meson}Cat_{year}.root'.format(**spec)
...
if __name__ == "__main__":
   ...
   hMH_bin2 = projection(1 , mytree, 100., 170., -0.5, 0., 2)
   hMH_bin3 = projection(1 , mytree, 100., 170., 0., 0.5, 3 )
   hMH_bin4 = projection(1 , mytree, 100., 170., 0.5, 1., 4 )
