...
void datacompare_resid(const char* Meson) {
    ...
    TH1F* Torino_ggH_hist = (TH1F*) Torino_presel->Get("h_mH_ggH");
    TH1F* Torino_VBF_hist = (TH1F*) Torino_presel->Get("h_mH_VBF");
    RooDataHist* Torino_ggH_data = new RooDataHist("dataset_ggH", "dataset_ggH", *(Torino_workspace->var("mesonGammaMass")), Torino_ggH_hist);
    RooDataHist* Torino_VBF_data = new RooDataHist("dataset_VBF", "dataset_VBF", *(Torino_workspace->var("mesonGammaMass")), Torino_VBF_hist);
    ...
    std::cout << "Torino (July 24): mean=" << Torino_ggH_pdf_mean << ", sigma=" << Torino_ggH_pdf_width << std::endl;
    std::cout << "MIT (July 22): mean=" << MIT_ggH_pdf_mean << ", sigma=" << MIT_ggH_pdf_width << std::endl;
    std::cout << "GFcat: " << Meson << "Cat signal VBF PDF parameters (preselection)" << std::endl;
    std::cout << "Torino (July 24): mean=" << Torino_VBF_pdf_mean << ", sigma=" << Torino_VBF_pdf_width << std::endl;
    std::cout << "MIT (July 22): mean=" << MIT_VBF_pdf_mean << ", sigma=" << MIT_VBF_pdf_width << std::endl;
    std::cout << "*************************************************" << std::endl;
    ...
    Torino_ggH_data->plotOn(ggH_frame_Torino, Binning(500, 110, 160));
    Torino_VBF_data->plotOn(VBF_frame_Torino, Binning(500, 110, 160));
    Torino_observed_data->plotOn(bkg_frame_Torino, Binning(50, 110, 160));
    MIT_ggH_data->plotOn(ggH_frame_MIT, Binning(500, 110, 160));
    MIT_VBF_data->plotOn(VBF_frame_MIT, Binning(500, 110, 160));
    MIT_observed_data->plotOn(bkg_frame_MIT, Binning(50, 110, 160));
    ...
    ggH_frame_Torino->SetYTitle(Form("events/0.1 GeV"));
    ...
    VBF_frame_Torino->SetYTitle(Form("events/0.1 GeV"));
    ...
    ggH_frame_MIT->SetTitle(Form("MIT GFcat %sCat ggH signal fit & residuals (presel)", Meson));
    ggH_frame_MIT->SetXTitle(Form("m_{#%s#gamma} [GeV/c^{2}]", meson));
    ggH_frame_MIT->SetYTitle(Form("events/0.1 GeV"));
    resid_ggH_frame_MIT->SetTitle("");
    resid_ggH_frame_MIT->SetXTitle("");
    resid_ggH_frame_MIT->SetLabelSize(0.07, "XY");

    VBF_frame_MIT->SetTitle(Form("MIT GFcat %sCat VBF signal fit & residuals (presel)", Meson));
    VBF_frame_MIT->SetXTitle(Form("m_{#%s#gamma} [GeV/c^{2}]", meson));
    VBF_frame_MIT->SetYTitle(Form("events/0.1 GeV"));
    resid_VBF_frame_MIT->SetTitle("");
    resid_VBF_frame_MIT->SetXTitle("");
    resid_VBF_frame_MIT->SetLabelSize(0.07, "XY");
    
    bkg_frame_MIT->SetTitle(Form("MIT GFcat %sCat background fit & residuals (presel)", Meson));
    ...
    ggH_frame_Torino->Print();
    legend_ggH_resid_Torino.AddEntry(ggH_frame_Torino->findObject(Form("crystal_ball_%s_GFpreselection_ggH_Norm[mesonGammaMass]", Meson)), "Torino DoubleCrystalBall (July 20)", "l");
    legend_ggH_resid_Torino.AddEntry(ggH_frame_Torino->findObject("h_dataset_ggH"), "Torino signal dataset (July 20)", "p");
    ...
    c_ggH_resid_Torino.SaveAs(Form("compare/presel_signal_ggH_resid_Torino_GF_%s_JUL24.png", Meson));
    ...
    legend_ggH_resid_MIT.AddEntry(ggH_frame_MIT->findObject(Form("crystal_ball_%sCat_GFcat_ggH_Norm[mh]_Range[fit_nll_crystal_ball_%sCat_GFcat_ggH_datahist_GFcat_ggH]_NormRange[fit_nll_crystal_ball_%sCat_GFcat_ggH_datahist_GFcat_ggH]", Meson, Meson, Meson)), "MIT DoubleCrystalBall (July 3)", "l");
    legend_ggH_resid_MIT.AddEntry(ggH_frame_MIT->findObject("h_datahist_GFcat_ggH"), "MIT signal datahist (July 3)", "p");
    pad1_ggH_MIT.cd();
    ggH_frame_MIT->Draw();
    ...
    pad1_ggH_MIT.Draw();
    pad2_ggH_MIT.Draw();
    c_ggH_resid_MIT.SaveAs(Form("compare/presel_signal_ggH_resid_MIT_GF_%s_JUL24.png", Meson));
    ...
    legend_VBF_resid_Torino.AddEntry(VBF_frame_Torino->findObject(Form("crystal_ball_%s_GFpreselection_VBF_Norm[mesonGammaMass]", Meson)), "Torino DoubleCrystalBall (July 20)", "l");
    legend_VBF_resid_Torino.AddEntry(VBF_frame_Torino->findObject("h_dataset_VBF"), "Torino signal dataset (July 20)", "p");
    ...
    c_VBF_resid_Torino.SaveAs(Form("compare/presel_signal_VBF_resid_Torino_GF_%s_JUL24.png", Meson));
    ...
    VBF_frame_MIT->Draw();
    legend_VBF_resid_MIT.AddEntry(VBF_frame_MIT->findObject(Form("crystal_ball_%sCat_GFcat_VBFH_Norm[mh]_Range[fit_nll_crystal_ball_%sCat_GFcat_VBFH_datahist_GFcat_VBFH]_NormRange[fit_nll_crystal_ball_%sCat_GFcat_VBFH_datahist_GFcat_VBFH]", Meson, Meson, Meson)), "MIT DoubleCrystalBall (July 3)", "l");
    legend_VBF_resid_MIT.AddEntry(VBF_frame_MIT->findObject("h_datahist_GFcat_VBFH"), "MIT signal datahist (July 3)", "p");
    ...
    pad1_VBF_MIT.Draw();
    pad2_VBF_MIT.Draw();
    c_VBF_resid_MIT.SaveAs(Form("compare/presel_signal_VBF_resid_MIT_GF_%s_JUL24.png", Meson));
    ...
    legend_data_resid_Torino.AddEntry(bkg_frame_Torino->findObject("chebychev_GFpreselection_bkg_Norm[mesonGammaMass]"), "Torino Chebychev dof=4 (July 20)", "l");
    legend_data_resid_Torino.AddEntry(bkg_frame_Torino->findObject("h_observed_data"), "Torino background dataset (July 20)", "p");
    ...
    c_data_resid_Torino.SaveAs(Form("compare/presel_bkg_observed_data_resid_Torino_GF_%s_JUL24.png", Meson));
    ...
    bkg_frame_MIT->Draw();
    legend_data_resid_MIT.AddEntry(bkg_frame_MIT->findObject(Form("chebychev3_%sCat_GFcat_Norm[mh]_Range[fit_nll_chebychev3_%sCat_GFcat_datahist_%sCat_GFcat]_NormRange[fit_nll_chebychev3_%sCat_GFcat_datahist_%sCat_GFcat]", Meson, Meson, Meson, Meson, Meson)), "MIT Chebychev dof=4 (July 3)", "l");
    legend_data_resid_MIT.AddEntry(bkg_frame_MIT->findObject("h_observed_data"), "MIT background datahist (July 3)", "p");
    ...
    pad1_data_MIT.Draw();
    pad2_data_MIT.Draw();
    c_data_resid_MIT.SaveAs(Form("compare/presel_bkg_observed_data_resid_MIT_GF_%s_JUL24.png", Meson));
