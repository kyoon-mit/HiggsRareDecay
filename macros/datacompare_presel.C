...
void datacompare_presel(const char* Meson) {
    ...
    TH1F* MIT_ggH_signal = new TH1F("MIT_ggH_signal", "MIT (June 26) Pt:40,40", 100., 170., 70);
      TH1F* MIT_ggH_signal_ = new TH1F("MIT_ggH_signal_", "MIT (June 26) Pt:38,38", 100., 170., 70);
    ...
    TH1F* MIT_VBF_signal = new TH1F("MIT_VBF_signal", "MIT (June 26) Pt:40,40", 100., 170., 70);
      TH1F* MIT_VBF_signal_ = new TH1F("MIT_VBF_signal_", "MIT (June 26) Pt:38,38", 100., 170., 70);
    ...
    TH1F* MIT_comb_signal = new TH1F("MIT_comb_signal", "MIT (June 26) Pt:40,40", 100., 170., 70);
      TH1F* MIT_comb_signal_ = new TH1F("MIT_comb_signal_", "MIT (June 26) Pt:38,38", 100., 170., 70);
        // TH1F* MIT_comb_signal__ = new TH1F("MIT_comb_signal__", "MIT (March 20) Pt:38,38 ph=WP90", 100., 170., 70);

    TH1F* Torino_data_bkg = new TH1F("Torino_data_bkg", "Torino (June 26)", 100., 170., 70);
    TH1F* MIT_data_bkg = new TH1F("MIT_data_bkg", "MIT (June 26) Pt:40,40", 100., 170., 70);
      TH1F* MIT_data_bkg_ = new TH1F("MIT_data_bkg_", "MIT (June 26) Pt:38,38", 100., 170., 70);
    ...
    c_ggH_hist.SaveAs(Form("compare/presel_signal_ggH_hist_compare_GF_%s_JUN26.png", Meson));
    c_ggH_hist.Close();
    ...
    c_VBF_hist.SaveAs(Form("compare/presel_signal_VBF_hist_compare_GF_%s_JUN26.png", Meson));
    c_VBF_hist.Close();
    ...
    c_comb_hist.SaveAs(Form("compare/presel_signal_comb_hist_compare_GF_%s_JUN26.png", Meson));
    c_comb_hist.Close();
    ...
    c_data_hist.SaveAs(Form("compare/presel_bkg_observed_data_hist_compare_GF_%s_JUN26.png", Meson));
    c_data_hist.Close();
}
