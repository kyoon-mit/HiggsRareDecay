                ...
                const char* channel )
{
    ...
    if ( std::strcmp(channel, "phi") == 0 ) {
        //fileformat = "/work/submit/kyoon/RareHiggs/data/cat_phi/cat_phi_VBF/test/test_mc%d_VBFcat_PhiCat_2018.root";
    ...
    // dataloader->AddVariable("goodMeson_massErr", "goodMeson_massErr", "GeV/c^2", 'F'); too high corr
    ...
    // dataloader->AddVariable("nGoodJets", "nGoodJets", "", 'F'); too high corr
    ...
    const char* trainTreeEventSplitStr = "(Entry$ % 3) >= 1"; //"(Entry$ % 10)>=5";
    const char* testTreeEventSplitStr = "(Entry$ % 3) < 1"; //"(Entry$ % 10)<5";
    ...
    */
    ...
    if (useBDTG)
    {
        ...
        */
        factory.BookMethod(dataloader,TMVA::Types::kBDT, "BDTG_d3_t400",
                      "!V:NTrees=400:BoostType=Grad:Shrinkage=0.30:MaxDepth=3:SeparationType=GiniIndex:nCuts=20:UseRandomisedTrees:UseNvars=8:UseBaggedBoost:BaggedSampleFraction=0.5" );
        /*
        ...
        */
        factory.BookMethod(dataloader,TMVA::Types::kBDT, "BDTG_d4_t400",
                      "!V:NTrees=400:BoostType=Grad:Shrinkage=0.30:MaxDepth=4:SeparationType=GiniIndex:nCuts=20:UseRandomisedTrees:UseNvars=8:UseBaggedBoost:BaggedSampleFraction=0.5" );
        /*
    ...
    if (useDL)
    {
        ...
        // Define DNN layout
        TString inputLayoutString = "InputLayout=1|1|18";
        TString batchLayoutString= "BatchLayout=1|128|18";
