                ...
                const char* channel )
{
    ...
    if ( std::strcmp(channel, "phi") == 0 ) {
        fileformat = "/work/submit/kyoon/RareHiggs/data/2023/FEB22/outname_mc%d_GFcat_PhiCat_2018.root";
        sgnfile = TFile::Open(Form(fileformat, 1017), "READ");
    } else if ( std::strcmp(channel, "rho") == 0 ) {
        fileformat = "/work/submit/kyoon/RareHiggs/data/2023/FEB22/outname_mc%d_GFcat_RhoCat_2018.root";
