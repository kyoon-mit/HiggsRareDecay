...
void TMVA_VBF_comb ( const char* outFileName )
{
    ...
    // Open files
    TString fileformat;
    TFile* sgnfile = TFile::Open("/work/submit/kyoon/RareHiggs/data/2023/JUN20_comb/VBF_combined_signal.root", "READ");
    TFile* bkgfile = TFile::Open("/work/submit/kyoon/RareHiggs/data/2023/JUN20_comb/VBF_combined_background.root", "READ");
